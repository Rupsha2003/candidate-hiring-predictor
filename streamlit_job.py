...
st.markdown("""
Welcome! Enter your details to predict whether you'll be hired. If not hired, we'll suggest ways to improve your chances based on the most influential factors.
""")

# Note about EducationLevel
st.markdown("""
**Note on Education Level**: 
- **Bachelor’s** includes all undergraduate degrees (e.g., B.A., B.Sc., B.Tech).
- **Master’s** and **PhD** are advanced degrees, with PhD offering the highest hiring probability (~56%).
""")
